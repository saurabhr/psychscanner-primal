...
- Only the feedback-scored task cards: `rm_*` and `pal50` — see [`examples/tasks/`](examples/tasks/) and the [Demonstration Suite](https://saurabhr.github.io/psychscanner-primal/demonstration_suite/) docs.
